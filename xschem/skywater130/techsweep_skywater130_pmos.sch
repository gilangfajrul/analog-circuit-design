...
compose l_vec  values 0.15 0.2 0.3 0.4 0.5 1 5 10
  ...
  foreach var2 $&vg_vec
    ...
    foreach var3 $&vd_vec
      ...
      foreach var4 $&vb_vec
        alter vsb $var4
	run 
	wrdata techsweep_skywater130_pmos.txt noise1.all
	destroy all
	set appendwrite
...
*showmod
show
write techsweep_skywater130_pmos.raw
.endc
"}
...
C {sky130_fd_pr/corner.sym} 1080 -850 0 0 {name=CORNER only_toplevel=false corner=tt}
